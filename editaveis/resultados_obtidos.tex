...
Dessa forma, cada experimento será analisado em uma seção própria.
...
do cross validation, o que demonstra que até o proximo experimento deve ser
...
um perfil mais geral quanto aos sistemas operacionais usados, pois para o
...
Para o Gráfico \ref{fig:segundo_experimento}, os \textit{labels} são, respectivamente:
