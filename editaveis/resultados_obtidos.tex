...
observa-se que a a precisão do aprendizado de máquina é de apenas 12,9\%,
...
experimento deve ser realizado melhorias quanto ao tratamento dos, como a
definição do perfil do usuário, que pode ser melhorados afim de que os
