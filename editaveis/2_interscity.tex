...
integração de dados de recursos de cidades inteligentes. Esses microsserviços
...
Atualmente o InterSCity está em desenvolvimento, e embora não conte
...
desenvolvimento da proposta neste trabalho. Houve ainda a troca de tecnologia de banco
...
operações específicas e customizadas, por chamadas diversas. O projeto e o
andamento da implementação serão discutidos no Capítulo \ref{chapter:architecture},
bem como o funcionamento do serviço que desenvolvemos.
